...
serial_tc5_declaration(RX_BUF_LENGTH, TX_BUF_LENGTH, 32, A3);
serial_tc4_declaration(RX_BUF_LENGTH, TX_BUF_LENGTH, 33, 2);

auto &serial_leg1 = serial_tc7; // serial_tc2_t& serial_leg2=serial_tc2;
auto &serial_leg2 = serial_tc8;
auto &serial_leg3 = serial_tc5;
auto &serial_leg4 = serial_tc4;
