...
#define serial_tc_declaration(id,rx_length,tx_length,rx_pin,tx_pin) \
...
> serial_tc##id##_t; \
\
serial_tc##id##_t serial_tc##id(rx_pin, tx_pin);

#define serial_tc0_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(0,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc1_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(1,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc2_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(2,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc3_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(3,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc4_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(4,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc5_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(5,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc6_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(6,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc7_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(7,rx_length,tx_length,rx_pin,tx_pin)

#define serial_tc8_declaration(rx_length,tx_length,rx_pin,tx_pin) \
serial_tc_declaration(8,rx_length,tx_length,rx_pin,tx_pin)
  ...
  namespace soft_uart
  {
    ...
    > class serial: public HardwareSerial 
    {
      public:
        ...
        serial(uint32_t rx_pin = default_pins::DEFAULT_RX_PIN, uint32_t tx_pin = default_pins::DEFAULT_TX_PIN)
        { 
